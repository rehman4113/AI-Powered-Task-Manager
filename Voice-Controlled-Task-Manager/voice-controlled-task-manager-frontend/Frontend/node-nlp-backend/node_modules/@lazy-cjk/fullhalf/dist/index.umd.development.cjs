(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@lazy-cjk/fullhalf-char-code'), require('uni-string'), require('deepmerge'), require('@lazy-cjk/fullhalf-data')) :
	typeof define === 'function' && define.amd ? define(['exports', '@lazy-cjk/fullhalf-char-code', 'uni-string', 'deepmerge', '@lazy-cjk/fullhalf-data'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.LazyCjkFullhalf = {}, global.fullhalfCharCode, global.UString, global.deepmerge, global.fullhalfData));
})(this, (function (exports, fullhalfCharCode, UString, deepmerge, fullhalfData) { 'use strict';
